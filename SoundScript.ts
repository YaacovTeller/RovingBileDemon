...
function multiSoundSelector(soundArray: Array<sound>, inSeries?: boolean) {
...
let bilefolder:string = "Sound/Bilesound/";
let enemyfolder:string = "Sound/Enemysound/";
let combatfolder:string = "Sound/Combat/"
...
var bileHitArray: Array<sound> = [BileHit1,BileHit2,BileHit3];
var windArray: Array<sound> = [Fart1,Fart2,Fart3,Fart4,Fart5,Fart6];
var swipeArray: Array<sound> = [Swipe1,Swipe2,Swipe3,Swipe4,Swipe5];
var bileMoveArray: Array<sound> = [BileMove1,BileMove2,BileMove3,BileMove4]

var chickArray: Array<sound> = [Chick1,Chick2,Chick3,Chick4,Chick5,Chick6];
var chickDieArray: Array<sound> = [ChickDie1,ChickDie2];

var walkArray: Array<sound> = [Foot1,Foot2,Foot3,Foot4];
var spurArray: Array<sound> = [Spur1,Spur2,Spur3,Spur4];
var manDieArray: Array<sound> = [ManDie1,ManDie2,ManDie3,ManDie4];
var manHitArray: Array<sound> = [ManHit1,ManHit2];
var manShoutArray: Array<sound> = [ManDrop,ManShout1,ManShout2,ManShout3];
var lordTauntArray: Array<sound> = [LordTaunt1,LordTaunt2,LordTaunt3,LordTaunt4,LordTaunt5,LordTaunt6,LordTaunt7,LordTaunt8];
